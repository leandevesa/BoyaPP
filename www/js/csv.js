...
function inicializarCSV() {
    ...
    csv = "Empresa,Edad,Nombre,Apellido,Celular,Colegio,Instagram,Mail,Anio Egreso\n";
    csv += ",,,,,,,\n";
}
...
function generarCSV(unContacto, unaEmpresa, unaEdad) {
    ...
    linea += unContacto.colegio + ",";
    linea += unContacto.instagram + ",";
    linea += unContacto.mail + ",";
    linea += unContacto.anoEgreso + ",";
...
function downloadCSV(unaEmpresa, fecha) {
    ...
    var filename = "Contactos (" + unaEmpresa + "-" + edad + "-" + fecha + ").csv";
